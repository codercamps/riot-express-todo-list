...
function updateRemoteApp() {
    return ssh.execCommand(
        'mkdir riot-express-todo-list && cp -r riot-express-todo-list/* riot-express-todo-list/ && rm -rf riot-express-todo-list-temp', {
            cwd: '/home/ubuntu'
    });
}
...
function sshConnect() {
    ...
    .connect({
        ...
        host: 'ec2-54-196-168-193.compute-1.amazonaws.com',
        username: 'ubuntu',
        privateKey: 'todo1-key.pem'
    })
    .then(function() {
